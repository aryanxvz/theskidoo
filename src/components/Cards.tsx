...
export const Cards = () => {
    return (
        <section className="py-60 bg-[#1C423C]">
            ...
            <div className="flex flex-wrap justify-center mx-10 lg:mx-40 2xl:mx-72 gap-6">
                <div className="cursor-pointer bg-[#FBEEAF] text-[#1C423C] border-2 border-[#1C423C] overflow-hidden pr-8 relative h-[22rem] w-[20rem] transition rounded-3xl hover:scale-105">
            ...
            <div className="flex justify-center">
                <button className="flex justify-center items-center gap-1 text-2xl font-bold px-6 py-3 lg:px-8 lg:py-4 bg-[#FDCE00] border-[#1C423C] border-2 rounded-2xl shadow-[5px_5px_0px_0px_#FFF9E9] my-12 group hover:scale-110 transition-all">
